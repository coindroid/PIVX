...
QnodeCoin-Project/QnodeCoin repository.
...
Setup
---------
Configuring the github-merge tool for the QnodeCoin repository is done in the following way:

    git config githubmerge.repository QnodeCoin-Project/QnodeCoin
...
A script to optimize png files in the QnodeCoin
