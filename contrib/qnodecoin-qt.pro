...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/qnodecoin-cli.cpp \
           src/qnodecoin-tx.cpp \
           src/qnodecoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/qnodecoin.qrc src/qt/qnodecoin_locale.qrc

TRANSLATIONS += src/qt/locale/qnodecoin_bg.ts \
                src/qt/locale/qnodecoin_de.ts \
                src/qt/locale/qnodecoin_en.ts \
                src/qt/locale/qnodecoin_es.ts \
                src/qt/locale/qnodecoin_fi.ts \
                src/qt/locale/qnodecoin_fr.ts \
                src/qt/locale/qnodecoin_it.ts \
                src/qt/locale/qnodecoin_ja.ts \
                src/qt/locale/qnodecoin_pl.ts \
                src/qt/locale/qnodecoin_pt.ts \
                src/qt/locale/qnodecoin_ru.ts \
                src/qt/locale/qnodecoin_sk.ts \
                src/qt/locale/qnodecoin_sv.ts \
                src/qt/locale/qnodecoin_vi.ts \
                src/qt/locale/qnodecoin_zh_CN.ts \
                src/qt/locale/qnodecoin_zh_TW.ts
