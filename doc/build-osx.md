...
Build QnodeCoin Core
------------------------

1. Clone the QnodeCoin Core source code:

        git clone https://github.com/qnodecoin-project/qnodecoin
        cd qnodecoin
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/QnodeCoin"

    touch "/Users/${USER}/Library/Application Support/QnodeCoin/qnodecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/QnodeCoin/qnodecoin.conf"

The first time you run qnodecoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
