...
*Setup instructions for a gitian build of QnodeCoin using a Debian VM or physical system.*
...
- [Building QnodeCoin](#building-qnodecoin)
...
Clone the git repositories for qnodecoin and gitian and then checkout the qnodecoin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/qnodecoin-crypto/qnodecoin.git
cd qnodecoin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the qnodecoin repository
...
To build QnodeCoin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the qnodecoin repository.
...
```bash
    ...
    From https://github.com/qnodecoin-crypto/qnodecoin
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/qnodecoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/qnodecoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/qnodecoin-build.assert
```
...
[qnodecoin/gitian.sigs](https://github.com/qnodecoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
