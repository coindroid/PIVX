...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the qnodecoin unit tests or QA tests
...
[Translation Process](https://github.com/qnodecoin-project/qnodecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the QnodeCoin Core project, and is not to be
confused with overall QnodeCoin Network Protocol consensus changes.
...
Where a patchset proposes to change the QnodeCoin consensus, it must have been
