...
extern UniValue DoZpivxSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzpivxseed(const UniValue& params, bool fHelp);
extern UniValue getzpivxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpivx(const UniValue& params, bool fHelp);
extern UniValue dzpivxstate(const UniValue& params, bool fHelp);
