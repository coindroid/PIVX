...
extern UniValue DoZqncSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzqncseed(const UniValue& params, bool fHelp);
extern UniValue getzqncseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzqnc(const UniValue& params, bool fHelp);
extern UniValue dzqncstate(const UniValue& params, bool fHelp);
