...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zpivxspends need to use the cs_spendcache
...
public:
    ...
    string GetUniqueWalletBackupName(bool fzpivxAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzQNCTracker> zpivxTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivxTracker = std::unique_ptr<CzQNCTracker>(new CzQNCTracker(strWalletFile));
    }
