...
#ifndef QnodeCoin_ZQNCTRACKER_H
#define QnodeCoin_ZQNCTRACKER_H
...
public:
    CzQNCTracker(std::string strWalletFile);
    ~CzQNCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzQNCWallet* zQNCWallet = NULL);
