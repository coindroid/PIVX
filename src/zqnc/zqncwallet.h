...
#ifndef QnodeCoin_ZQNCWALLET_H
#define QnodeCoin_ZQNCWALLET_H
...
public:
    CzQNCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZQNC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZQNC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
