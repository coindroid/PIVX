                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzQNCPathCustom = GetArg("-zpivxbackuppath", "");
    ...
    if(!strzQNCPathCustom.empty()) {
        ui->wallet_customzpivxbackuppath->setText(QString::fromStdString(strzQNCPathCustom));
        ui->wallet_customzpivxbackuppath_label->setVisible(true);
        ui->wallet_customzpivxbackuppath->setVisible(true);
    }
