                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzQNCPathCustom = GetArg("-zqncbackuppath", "");
    ...
    if(!strzQNCPathCustom.empty()) {
        ui->wallet_customzqncbackuppath->setText(QString::fromStdString(strzQNCPathCustom));
        ui->wallet_customzqncbackuppath_label->setVisible(true);
        ui->wallet_customzqncbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzQNCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the QnodeCoin RPC console.") + "<br>" +
