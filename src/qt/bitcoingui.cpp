                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QnodeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQNC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QnodeCoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QnodeCoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the QnodeCoin Core help message to get a list with possible QnodeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QnodeCoin Core client") + " " + networkStyle->getTitleAddText();
