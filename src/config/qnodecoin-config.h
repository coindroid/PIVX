/* src/config/qnodecoin-config.h.  Generated from qnodecoin-config.h.in by configure.  */
/* src/config/qnodecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.qnodecoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QnodeCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QnodeCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qnodecoin"
