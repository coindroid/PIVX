...
from fake_stake.base_test import QnodeCoin_FakeStakeTest

class zQNCValidCoinSpendTest(QnodeCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zQNCs..." % DENOM_TO_USE)
